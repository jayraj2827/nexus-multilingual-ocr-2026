"""
NexusOCR Document OCR Feature Service.
Coordinates Tier 1 PyMuPDF and Tier 2 PaddleOCR engines across document pages.
"""
...
class DocumentOCRService:
    """End-to-End Document Intelligence Service implementing 2-Tier OCR Routing."""
